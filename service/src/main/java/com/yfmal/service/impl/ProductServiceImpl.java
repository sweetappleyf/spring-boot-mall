...
import com.yfmal.dao.ProductImgMapper;
import com.yfmal.dao.ProductMapper;
import com.yfmal.dao.ProductParamsMapper;
import com.yfmal.dao.ProductSkuMapper;
import com.yfmal.entity.*;
import com.yfmal.service.ProductService;
...
public class ProductServiceImpl implements ProductService {
    ...
    public ResultVO getProductsByCategoryId(int categoryId, int pageBNum, int limit) {
        ...
        //4.封装返回数据
        PageHelper<ProductVO> pageHelper = new PageHelper<>(count,pageBNum,productVOS);
